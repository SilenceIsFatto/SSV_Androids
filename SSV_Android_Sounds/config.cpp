...
class CfgSounds 
{
	...
	class SSV_Android_Communication_1
	{
		...
		maxDistance = 50;
		sound[] = {"\SSV_Android_Sounds\sounds\android_communication_1.ogg", 75, 0.8, 100};
		titles[] = {0, ""};
	};
	class SSV_Android_Communication_2
	{
		...
		maxDistance = 50;
		sound[] = {"\SSV_Android_Sounds\sounds\android_communication_2.ogg", 75, 0.8, 100};
		titles[] = {0, ""};
	};
	class SSV_Android_Communication_3
	{
		...
		maxDistance = 50;
		sound[] = {"\SSV_Android_Sounds\sounds\android_communication_3.ogg", 75, 0.8, 100};
		titles[] = {0, ""};
	};
	...
	class SSV_Android_Attack_1
	{
		...
		maxDistance = 100;
		sound[] = {"\SSV_Android_Sounds\sounds\android_attack_1.ogg", 75, 0.5, 100};
		titles[] = {0, ""};
	};
	class SSV_Android_Attack_2
	{
		...
		maxDistance = 100;
		sound[] = {"\SSV_Android_Sounds\sounds\android_attack_2.ogg", 75, 0.5, 100};
		titles[] = {0, ""};
	};
};