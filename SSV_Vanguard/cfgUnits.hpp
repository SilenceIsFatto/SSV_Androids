	...
	class SSV_Unit_Vanguard_J13: SSV_Unit_Android_Base
	{
	...
	class SSV_Unit_Vanguard_Stealth: SSV_Unit_Android_Base
	{
		...
		linkedItems[]=
		{
			...
			"JMSJEFF_FarmorAdvisor_armor_black",
			"ItemMap",
			"ItemCompass",
			"ItemWatch",
			"ItemRadio"
	...
	class SSV_Unit_Vanguard_QRF: SSV_Unit_Android_Base
	{
		...
		linkedItems[]=
		{
			...
			"JMSJEFF_ChestVestS_armor_black",
			"ItemMap",
			"ItemCompass",
			"ItemWatch",
			"ItemRadio"
	...
	class SSV_Unit_Vanguard_Worker: SSV_Unit_Android_Base
	{
